...
Подведем итог:    
Исходя из заметов скорости видим что tun немного быстрее tap.    
    
В этом нет ничего удивительного т.к. tup работает на L3 уровне (передает только IP пакеты), а tap работает на уровне L2.    
